...
const SLUG_PREFIX = "candidate-interview-";
...
const login = async email => {
  const response = await request(app)
    .post("/api/auth/login")
    .set("User-Agent", "CareerForge Candidate Interview Integration Test")
...
const createCompany = recruiterId =>
  Company.create({
    ownerId: recruiterId,
    companyName: "Candidate Interview Test Company",
...
const createApplication = ({ candidateId, job, company }) =>
  Application.create({
    ...
    coverLetter: "Candidate interview integration cover letter.",
    resumeSnapshot: {
...
describe("Candidate Interview APIs", () => {
  beforeEach(cleanup);
  afterEach(cleanup);
