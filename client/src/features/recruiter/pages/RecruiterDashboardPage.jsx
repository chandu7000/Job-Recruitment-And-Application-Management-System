...
function RecruiterDashboardPage() {
  ...
  const loader = useCallback(
    (signal) => recruiterApi.dashboard(signal),
    [],
  )
  ...
  const {
    ...
    error,
    reload,
  } = useRecruiterResource(loader)

  if (loading) {
    return (
      <PageLoader label="Loading recruiter dashboard" />
    )
  }
  ...
  const stats = [
    ...
    [
      'Shortlisted',
      applicationStatuses.SHORTLISTED ?? 0,
    ],
    [
      'Interviews',
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-2 text-slate-600">
          Review your real recruitment activity and company readiness.
        </p>
      </header>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        {companies.length ? (
          ...
          <p className="mt-4 text-slate-600">
            Create your company profile to begin verification.
          </p>
        )}
